...
def verify(image_path, identity, database, model):
    ...
    # Euclidean distance is calculated as the norm of the difference between the two vectors.
    # This measures the straight-line distance between two points (vectors) in the encoding space.
...
def who_is_it(image_path, database, model):
    ...
    for (name, db_enc) in database.items():
        ...
        dist = tf.norm(encoding - db_enc, axis=-1)
